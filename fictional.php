...
<body>
  <h1 class="section-heading">Fictional Books</h1>
  <br>
  <hr>

<?php
// Sirf 9, 10, 11, 12, 13 wali books fetch karna
$sql = "SELECT book_id, title, author, description, price, image 
        FROM books 
        WHERE book_id IN (19,20,21,22,23) 
